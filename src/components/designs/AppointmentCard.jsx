        ...
        return (
            ...
            <div className=" rounded-xl bg-slate-900 text-neutral-100 h-40 w-auto relative
                pt-6 px-2 shadow-md shadow-black/20 col-span-1 min-w-[100px] md:min-w-[180px] lg:min-w-[230px]">
                  ...
                  <button data-tip data-for="tip1" className="h-4 w-4 hover:h-5 hover:w-5  rounded-full bg-orange-400 mr-1 flex flex-col items-center justify-center"><i className="fa-solid fa-minus  text-sm" ></i></button>
                  <button data-tip data-for="tip2" className="h-4 w-4 hover:h-5 hover:w-5  rounded-full bg-green-400 mr-1 flex flex-col items-center justify-center"><i className="fa-solid fa-check  text-sm" ></i></button>
                </div >
                ...
                <ReactTooltip id='tip1' place='top'>Reschedule</ReactTooltip>
                <ReactTooltip id='tip2' place='top'>Done</ReactTooltip>
                </div>
